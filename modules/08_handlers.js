...
export function setupEventListeners() {
    ...
    createMasterEffectKnobs({ eq: state.masterEq, comp: state.masterComp, delay: state.masterDelay, distortion: state.masterDistortion, reverb: state.masterReverb }, (key, value) => {
