...
export function initDom() {
    const elementMap = {
        ...
        playlistAddSelect: 'playlist-add-select',
        playlistAddBtn: 'playlist-add-btn',
        playlistPlayBtn: 'playlist-play-btn',
        playlistPrevBtn: 'playlist-prev-btn',
        playlistNextBtn: 'playlist-next-btn',
        playlistStopBtn: 'playlist-stop-btn',
        playlistAutoAdvance: 'playlist-auto-advance',
